  ...
  return {
    ...
    '@graph': [
      ...
      },
      {
        '@type': 'ItemList',
        '@id': `${NAV_URL}#toollist`,
        name: 'AIHH.ai free online tools',
...
function buildHubCrawlSection(toolList) {
  ...
  let html = `<section id="tool-directory-crawl" class="crawl-directory" aria-label="Complete tool directory (${toolList.length} tools)">\n`;
  html += `<h2>All ${toolList.length} free online tools</h2>\n<p>Static index for crawlers and users without JavaScript. Each tool has its own page with runnable features.</p>\n`;
...
function buildSiteData() {
  ...
  return {
    ...
    seo: {
      siteName: 'AIHH.ai',
      pageTitle: `AIHH.ai | ${count} Free Online Tools — Dev, SEO & Productivity`,
      metaDescription: `Browse ${count} free browser-based tools on AIHH.ai: JSON, JWT, Cron, SEO, PDF, image, CSV, privacy helpers, and more. No upload, no signup.`,
      metaKeywords: 'AIHH.ai,online tools,json formatter,jwt decoder,seo tools,free web utilities,pdf tools,image tools',
      ogImage: ogImageUrl,
      ogImageAlt: `AIHH.ai directory — ${count} free online tools with SEO-friendly pages`,
      heroBadge: `${count} Tools · Client-side · SEO-ready`,
      heroTitle: 'Find the right tool in seconds',
      heroHighlight: `${count} free utilities for Google traffic`,
      heroDescription: 'Each tool lives on its own subdomain with named preview images, unique titles, FAQs, and schema markup—this directory links them all for crawlers and users.',
      heroTags: ['No upload', 'SEO-friendly', 'Original code', 'Subdomain deploy'],
      matrixDescription: 'Development, SEO, office work, content, design, privacy, and productivity—organized by category.',
      mainCategoryTitle: 'Browse by category',
      mainCategoryDesc: 'Pick a workflow, then narrow down with subcategories.',
      subCategoryTitle: 'Subcategories',
      subCategoryAllDesc: 'All subcategories across the matrix.',
      subCategoryFilteredDesc: 'Subcategories for the selected main category.',
      resultPanelEyebrow: 'Live Result',
      resultPanelTitle: 'Matching tools',
      resultPanelTemplate: '{count} tools match your filters.',
      recommendedEyebrow: 'Recommended',
      recommendedTitle: 'Popular tools',
      recommendedDesc: 'High-intent utilities for developers and SEO workflows.',
      emptyText: 'No matches. Try another category or a broader keyword.',
      footerText: '© 2026 AIHH.ai · Each tool: tool00001.aihh.ai … tool00500.aihh.ai · Terms & Privacy in /legal/',
      articleSections: [
        { title: 'Why 100 focused tools first?', content: 'A tool network wins when every page solves one clear job. AIHH.ai ships 100 working utilities with shared quality bars—then scales to thousands of subdomains.' },
        { title: 'Built for users and Google', content: 'Each page includes runnable features, FAQs, privacy notes, canonical URLs, sitemaps, JSON-LD, and links back to this directory so crawlers and humans can navigate easily.' },
        { title: 'SEO-friendly tool cards and images', content: 'Every listing uses a descriptive filename (e.g. tool00001-json-formatter.svg), unique alt text, keyword chips, Schema.org WebApplication markup, and an ItemList so search engines understand the full matrix.' }
      ]
    },
